...
# Ini adalah kode yang BENAR dan RAPI untuk account_manager.py
# Script ini akan menulis ulang file tersebut secara otomatis.

target_file = os.path.join("core", "account_manager.py")

correct_code = r'''import json
import os
import datetime
...
if __name__ == "__main__":
    am = AccountManager()
    # print("Check DB:", am.get_all_accounts())
'''
...
try:
    ...
    print("✅ BERHASIL! File core/account_manager.py sudah diperbaiki.")
    print("🚀 Sekarang coba jalankan: python dashboard.py")
